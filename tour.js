const tourSteps = [
    ...
    { popover: { title: 'Dataset Catalog', description: "Welcome to the Dataset Catalog! This page gives you a bird's-eye view of all your monitored datasets and their AI-readiness." }, disableOverlay: true },
    ...
    { popover: { title: 'Dataset Overview', description: "You are now on the detailed dashboard for a specific dataset. Here you can analyze its quality dimensions deeply." }, disableOverlay: true },
    ...
    { popover: { title: 'Platform Settings', description: "Welcome to Platform Settings! Here you configure which datasets to monitor, how to assess them, and who gets notified." }, disableOverlay: true },
