const tourSteps = [
    ...
    { element: '.page-subtitle', popover: { title: 'Dataset Overview', description: "You are now on the detailed dashboard for a specific dataset. Here you can analyze its quality dimensions deeply.", side: 'bottom', align: 'start' }, disableOverlay: true },
    ...
    { element: '.page-subtitle', popover: { title: 'Platform Settings', description: "Welcome to Platform Settings! Here you configure which datasets to monitor, how to assess them, and who gets notified.", side: 'bottom', align: 'start' }, disableOverlay: true },
